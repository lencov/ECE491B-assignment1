...
def run_gelu(in_features: torch.FloatTensor) -> torch.FloatTensor:
    ...
    """
    from ece496b_basics.positionwise_feedforward import gelu
...
def run_get_batch(
    ...
    """
    from ece496b_basics.transformer_utils import get_batch
...
def run_softmax(in_features: torch.FloatTensor, dim: int) -> torch.FloatTensor:
    ...
    """
    from ece496b_basics.transformer_utils import softmax
...
def run_cross_entropy(inputs: torch.FloatTensor, targets: torch.LongTensor):
    ...
    """
    from ece496b_basics.transformer_utils import cross_entropy_loss
...
def get_adamw_cls() -> Type[torch.optim.Optimizer]:
    ...
    """
    from ece496b_basics.AdamW import AdamW
    return AdamW
...
def run_get_lr_cosine_schedule(
    ...
    """
    from ece496b_basics.transformer_utils import get_lr_cosine_schedule
...
def run_save_checkpoint(
    ...
    """
    from ece496b_basics.transformer_utils import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from ece496b_basics.transformer_utils import load_checkpoint
